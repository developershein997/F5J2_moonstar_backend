...
<head>
    ...
    <title>Burmar888| Dashboard</title>
...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <img src="{{ asset('assets/img/logo/Burmar888.jpg') }}" alt="Logo"
                class="brand-image img-circle elevation-3" style="opacity: .8">
            <span class="brand-text font-weight-light">Burmar888</span>
            </a>
            <!-- Brand Logo -->
...
@endcan
        ...
        <footer class="main-footer">
            <strong>Copyright &copy; 2025 <a href="">Burmar888</a>.</strong>
            All rights reserved.
            <div class="float-right d-none d-sm-inline-block">
                <b>Version</b> 3.2.2
                <span class="ml-2">
                    <a href="https://moonstar543.live/" target="_blank">https://moonstar543.live/</a>
                </span>
            </div>
        </footer>
